...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <form action="{{route('auth.token')}}" method="post">
                @csrf
                <div class="form-group col-8" style="margin-left: auto;margin-right: auto ; margin-top: 100px">
                    <input type="text" name="token" class="form-control " style="margin-left: auto;margin-right: auto" placeholder="کد تایید " autofocus required>
